...
CashFusion implementation, including protocol-level threats, Tor transport,
and key management. It is written for auditors, contributors, and future
maintainers.

**Privacy component map (names and roles):** see
[p2p-cashfusion-privacy-layers.md](./p2p-cashfusion-privacy-layers.md) for the
**implemented** stack: **Tor**, **NIP-59 gift-wrap**, **Pedersen**,
