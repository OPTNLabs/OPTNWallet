...
/// Serve the legacy write command through the shell-independent native provider.
#[tauri::command]
...
/// Serve the legacy read command through the shell-independent native provider.
#[tauri::command]
