...
/// Overwrite this string's bytes without changing its length or invalidating UTF-8.
/// This best-effort cleanup does not erase copies or guarantee compiler retention.
