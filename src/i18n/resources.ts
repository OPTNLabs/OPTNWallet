...
const baseTranslations = {
  en: {
    ...
    'onboarding.optionHardwareDescription': 'Ledger or Trezor, connected over USB.',
  ...
  es: {
    ...
    'onboarding.optionWatchOnlyDescription': 'Consulta saldos desde una clave publica. La firma ocurre en otro lugar.',
    'onboarding.optionHardware': 'Billetera de hardware',
    'onboarding.optionHardwareDescription': 'Ledger o Trezor, conectada por USB.',
    'onboarding.optionDesktopOnly': 'Solo en la aplicacion de escritorio',
  ...
  'zh-CN': {
    ...
    'onboarding.optionHardwareDescription': 'Ledger 或 Trezor，通过 USB 连接。',
