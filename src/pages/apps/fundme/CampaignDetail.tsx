...
const CampaignDetail: React.FC = () => {
  ...
  void contractsOK;
  void setContractsOK;
  void setContractCashStarter;
  void setContractCashStarterRefund;
  void setContractCashStarterStop;
  void setContractCashStarterClaim;
  void setContractCashStarterCancel;
  void contractManager;
  void setContractManager;
  void contractFailMinter;
  void setContractFailMinter;
  void setTransactionBuilder;
  void stopPending;
  void error;
  void setError;
  void pledgeDetails;
  void setPledgeDetails;
  void setUsersAddress;
