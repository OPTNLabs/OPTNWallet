...
const PledgeModal: React.FC<PledgeModalProps> = ({
  ...
  const [messageOver] = useState(false);
    ...
    >
      ...
      >
        ...
        <div className="absolute w-full h-[35px] top-0 bg-[#0AC18E] rounded-t-lg text-gray-50 text-xl font-semibold text-center drop-shadow-[2px_2px_3px_rgba(0,0,0,0.8)]">
          {addonT('module.legacyPledgeDetails', 'Enter pledge details')}
        </div>
        ...
        >
          <label className="relative">
            <b>{addonT('module.legacyName', 'Name')}:</b>
            <div className="absolute top-0 right-0">
              {addonT('module.legacyCharactersLeft', '{count} left', {
                count: nameCharacters,
              })}
            </div>
            <br />
            <input
              ...
              placeholder={addonT('module.legacyAnonymous', 'Anonymous')}
              required
          ...
          <label className="relative">
            <b>{addonT('module.legacyMessage', 'Message')}:</b>
            <div className="absolute top-[55px] right-0">
              {addonT('module.legacyCharactersLeft', '{count} left', {
                count: messageCharacters,
              })}
            </div>
            <br />
            <textarea
